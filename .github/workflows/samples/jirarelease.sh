...
versionid=$(curl --location  "https://devopsprodemo.atlassian.net/rest/api/2/project/10000/version?expand=issuesstatus&maxResults=25&orderBy=-sequence&startAt=0&status=unreleased&query=${content}" \
--header 'Content-Type: application/json' \
