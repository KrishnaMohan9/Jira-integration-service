...
#curl --location 'https://devopsprodemo.atlassian.net/rest/api/2/project/10000/version?expand=issuesstatus&maxResults=25&orderBy=-sequence&startAt=0&status=unreleased&status=unreleased' \
